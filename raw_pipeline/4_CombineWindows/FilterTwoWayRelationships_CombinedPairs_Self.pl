...
open PAIR, "$polyploidName\/$polyploidName-$polyploidName\_CombinedPairs_AllWindows.txt" or die $_;
open OUT, ">$polyploidName\/$polyploidName\_Ohnologs_CombinedFromSelf_OneWay.txt" or die $_;
